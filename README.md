...
docker pull rrdfe/leekserver:release-20181026    (待定)
docker pull dushaobin/leekserver:release-20181026   (待定)

启动docker

docker run -d  -p 3000:3000 -p 9030:9030 -p 3306:3306 -v ~/packages:/usr/app/packages dushaobin/leekserver:release-20181026
